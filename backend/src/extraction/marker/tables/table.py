from marker.schema.bbox import box_intersection_pct, merge_boxes, rescale_bbox
...
def get_table_pdftext(page: Page, table_box, space_tol=0.01, round_factor=4) -> list[list[str]]:
