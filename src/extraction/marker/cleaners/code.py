...
from marker.schema.block import Line, Span
    ...
    for page in pages:
        for block in page.blocks:
            ...
            is_code = [
                ...
                sum(is_indent) + comment_lines > len(block.lines) * 0.7,  # Indentation and comments are a majority
            ]

            if avg_font_size is not None:
                font_checks = [
                    mean(line_font_sizes) <= avg_font_size * 0.8,  # Lower than average font size and line height
