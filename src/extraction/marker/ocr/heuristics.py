...
from marker.schema.bbox import box_intersection_pct, rescale_bbox
...
def detect_bad_ocr(text, space_threshold=0.7, newline_threshold=0.6, alphanum_threshold=0.3):
    if len(text) == 0:
